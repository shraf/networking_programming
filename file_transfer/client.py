...
class ClientGUI:
    def __init__(self):
        ...
        self.select_file_button = tk.Button(self.root, text="Select File", command=self.select_file, bg="black", fg="white")
        self.select_file_button.pack(pady=10)

        self.send_button = tk.Button(self.root, text="Send File", command=self.send_file, state=tk.DISABLED, bg="black", fg="white")
